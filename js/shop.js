	...
	$.ajax({
			...
			success: function(dataReceived){
					...
					for (i = 0; i < dataReceived.ImagesInformation.length; i++) { 
		                 ...
		                 "<img  src='" + dataReceived.ImagesInformation[i].Ubicacion +"'></div>" + 
						...
						var productImg = document.getElementById(dataReceived.ImagesInformation[i].IDProducto).firstChild.firstChild;
						console.log("productImg: " + productImg);

    					productImg.addEventListener("click", function(){ goToDetails( this.parentNode.parentNode.getAttribute("id") )  });
